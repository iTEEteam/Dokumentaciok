...
%\comment{Milyen publikus metódusokkal rendelkezik. Metódusonként egy-három mondat arról, hogy a metódus mit csinál.}
	\begin{description}
		\item[Bullet(int damage, String enemyType)] Konstruktor
...
\item[void setEnemy(String e)] beállítja az ellenséget akire specializált
...
\item[static final int maxHP]  
\item[Path nextPath] A következő út címe
...
\item[void setHealth(int h)] beállítja a health értékét h-ra
...
\item[int getMana()] visszaadja a mana értékét


\subsection{Controller}
\begin{itemize}
\item Felelősség\\
A játékos interakcióit hajtja végre, vezérlést végzi.
\item Ősosztályok\\
Object
\item Interfészek\\
Nincs
\item Attribútumok\\
	\begin{description}
		\item[IGame igame] Game-hez hozzáférést biztosít
		\item[Field chosenField] itt tárolja a kiválasztott Fieldet
		\item[Path chosenPath] a kiválasztott Path
		\item[String chosenEnemy] a kiválasztott Enemy típus 
	\end{description}
\item Metódusok\\
	\begin{description}
		\item[void buyTower()]
		\item[void buyObstacle()] a chosenPath-re létrehoz egy akadály (crt+register)
		\item[void buySpeed/Intensity/Damage/EnemyTypeGem()] chosenField-en lévő tornyot fejleszti a függvény nevének megfelelő típusú kristállyal
		\item[void buyIntensity/RepairGem()] a chosenPath-en lévő akadályt fejleszti a függvény nevének megfelelő kristállyal
		\item[]
		\item[void setField(Field f)] chosenField setje
		\item[void setPath(Path p)] chosenPath setje
		\item[void setEnemyType(String et)] chosenEnemy setje
...
\item Attribútumok\\
	\begin{description}
		\item[static final int price] az ár, amennyi varázserőbe kerül.
	\end{description}
\item Metódusok\\
	\begin{description}
...
\item Metódusok\\
	\begin{description}
		\item[void slow(Enemy e)] lelassítja e Enemy-t
\item[void amortization()] amortizálja az akadályt
...
\item[void upgradeEnemy(String e)] egy ellenségtípusra növeli a sebzést.
...
\item Metódusok\\
	\begin{description}
		...
		\item[Map(Map map)] az osztály konstruktora, a paraméterként megadott névvel rendelkező fájlból betölti a pálya térképét
...
\item Attribútumok\\
	\begin{description}
		...
		\item[IGame igame] a Game interfésze, hogy elérje a Game-et
...
\item Metódusok\\
	\begin{description}
		...
		\item[ITower getITower()] megadja a mezőn álló tronyot, ha nincs, nullt ad
		\item[bool hasTower()] megmondja, hogy áll-e torony a mezőn
...
\item Attribútumok\\
	\begin{description}
		\item[IObstacle myIObstacle] az esetleg az úton levő akadályt tárolja
...
\item Metódusok\\
	\begin{description}
		...
		\item[bool deleteIObstacle()] kitörli a tárolójából az akadályt, ha van 
		\item[void registerIPathPlaceable(IPathPlaceable ipath)] beregisztrálja a paraméterként kapott objektumot
		\item[bool hasEnemy()] megmutatja, hogy van-e a cellán ellenség
		\item[bool deleteEnemy(Enemy e)] törli a Path-en lévő e Enemy-t
		...
		\item[IObstacle getIObstacle()] visszaadja az akadályt, ha van, ha nincs nullt ad
		\item[bool hasObstacle()] megmondja, hogy van-e akadály rajta
...
\item Attribútumok\\
	\begin{description}
		\item[int range/ speed/ damage, String eType] 
